...
const CHANGELOG = [
  {v:'1.1',date:'2026-05-14',changes:[
    'Worker代理始终返回200，通过X-Original-Status传递真实状态码，避免级联到失效代理',
    '移除失效的公共CORS代理（corsproxy.io、allorigins.win），仅使用自建Worker代理',
    '修复界面新闻URL（jiemian.com/article_list/146.html→404，改为首页）',
    '移除合规检查设置中的AI添加描述文本',
    'Worker新增/api/weibo/{uid}端点（微博Visitor Auth流程，待部署RSSHub后可用）',
  ]},
